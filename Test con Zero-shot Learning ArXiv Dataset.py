...
#suddivisione della colonna category per permettere al metodo di classificazione di ... i dati 
...
drop_list2 = ['categories', 'category1', 'category4', 'category3', 'category2']
...
meta1, meta2, meta3 = df7.randomSplit([0.4, 0.3, 0.3], seed=42)
...
predictedCategories = []
trueCategories = []
for i in tqdm(range(500)): #si andrà a modificare per ogni run il numero contenuto all'interno del range
